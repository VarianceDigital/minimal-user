# Minimal Flask + Bootstrap 5 + User Authentication Demo Project 
...
- basic user sign-up, login, logout mechanisms (and forms);
...
- The site makes use of the Flask session;
...
To install, first activate your virtual environment and then launch:
